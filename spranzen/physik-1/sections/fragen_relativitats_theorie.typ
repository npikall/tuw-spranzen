...
= Relativitätstheorie
qcounter.update(0)
#question[Wie lautet das Relativitätsprinzip?]
...
#question[Was ist Zeitdilatation?]
...
#question[Was ist das Zwillingsparadoxon und wie wird es gelöst?]
...
#question[Beschreiben Sie das Michelson-Morley Experiment. Welche Konsequenzen sind daraus zu ziehen?]
...
#question[Geben Sie die Lorentztransformation für ein relativ zu S mit der Geschwindigkeit v bewegtes System S' an. Erläutern Sie die Konsequenzen]
$
  t' & = gamma (t - (v/c)^2 x) \
  x' & = gamma (x - v t ) \
  y' & = y \
...
#question[Wie ändern sich Längen, Zeiten und die Masse bei hohen Geschwindigkeiten?]
...
#question[Welche Größen sind in der Relativitätstheorie invariant gegenüber der Lorentztransformation?]
- Lichtgeschwindigkeit
- Masse
/ Invariant: eigenschaften, die von allen Inertialsystemen als gleicher Wert beobachtet wird
#question[Wie lautet der relativistische Energieerhaltungssatz?]
$
  E (v) = (m c^2)/(sqrt(1 - (v/c)^2))
$

#question[Zeige das ein bewegte Uhr langsamer geht als eine ruhende]
Ruhende Lichtuhr vs Bewegte Lichtuhr
#missing-plot()
#question[Geben Sie eine geometrische Deutung der Lorentzkontraktion und der Zeitdilatation]
#missing-plot()
#question[Skizzieren Sie die Herleitung für das Additionstheorem der Geschwindigkeiten]
...
$
  x/t = w = (u + v)/(1 + (u v)/c^2)
$
#question[Wie lautet das Additionstheorem der Geschwindigkeiten?]
#missing[]
#question[Stelle die Galileitransformation der Lorentztransformation gegenüber?]
#figure(
  ctable(
...
#question[Was sind die Gründe für die Einführung der Lorentztransformation?]
- Grundlage der speziellen Relativitäts Theorie
- Berücksichtigt Zeitdilatation, Lorentzkontraktion (galilei'sche Physik nicht)

#question[Welche Konseqünzen ergeben sich daraus?]
...
#question[Was besagt die Energie-Masse-Äquivalentbeziehung]
...
#question[Wie lautet der relativistische Energiesatz? Zeigen Sie unter welchen Bedingungen der in der klassischen Mechanik gültige Ausdruck für die kinetische Energie folgt.]
$
  "missing"
$
...
#question[Wie lautet die Formel für die kinetische Energie in der Relativitätstheorie?]
$
  E_"kin" = gamma m c^2 - m c^2 = (gamma - 1) m c^2\
  gamma = 1/sqrt(1 - (v/c)^2)
$

#question[Wie lautet die Formel für die Gesamtenergie?]
$
