...
#definition(title: "Lineare Abhängigkeit")[
  ...
  $ a_1 v_1 + dots + a_k v_k = 0 #h(.5cm) ("Linearkombination") $ Sprich wenn es eine Summe aus Vektoren gibt die den
  Nullvektor bilden. Allerdings sind Vektoren linear unabhängig wenn nur
  folgende Linearkombination den Nullvektor ergibt: $ 0 v_1 + dots + 0 v_k = arrow(0) & #h(0.5cm) ("linear unabhängig") $
]
...
#definition(title: "Basis")[
  ...
  Die Vektoren $arrow(v_1), dots, arrow(v_n) in RR^n$ sind
  Basen, wenn gilt:
  $
...
#definition(title: "Determinante")[
  ...
  $
    ...
    = a_11 dot
    mat(a_22, a_23; a_32, a_33) - a_12 dot & mat(a_21, a_23; a_31, a_33) + a_13 dot
