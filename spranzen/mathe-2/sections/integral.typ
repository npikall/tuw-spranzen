...
#definition(title: "Integrationsbereiche")[
  ...
  + Cauchy Schwarzsche Ungleichung
    $
      chevron.l f , g chevron.r = integral.double_D f g thin d x thin d y lt.eq (integral.double_D f^2 thin d x thin d y)^(1 \/ 2) dot.op (integral.double_D g^2 thin d x thin d y)^(1 \/ 2)
    $
    $
      lr(|chevron.l x, y chevron.r|)^2 lt.eq chevron.l x , x chevron.r dot.op chevron.l y , y chevron.r
    $
  + Dreiecksungleichung
    $
