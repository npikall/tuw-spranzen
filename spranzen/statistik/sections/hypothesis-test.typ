#import "@preview/gentle-clues:1.1.0" as gc
...
#figure(
  table(
    columns:3,
    table.hline(),
    [Entscheidung], table.vline(), [H0 richtig], [H1 richtig],
    table.hline(),
    [H0 ablehnen],[Typ I Fehler],[korrekt],
    [H0 nicht ablehnen],[korrekt],[Typ II Fehler],
    table.hline(),
  ), kind:"none", supplement: "none"
)
